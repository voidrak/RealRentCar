                ...
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    @else
                        <div class="hidden justify-between items-center w-full lg:flex lg:w-auto" id="mobile-menu-2">
                            <ul class="flex flex-col mt-4 font-bold text-lg lg:flex-row lg:space-x-8 lg:mt-0">
                                <li>
        ...
        <footer class="px-4  sm:p-6 bg-gray-800">
            <div class="pt-10 mx-auto max-w-screen-xl relative">
                    ...
                    <div class="grid grid-cols-3 gap-8 ">
                        <div>
                            ...
                            <ul class=" text-gray-400">
                                <li class="mb-4">
                                    <a href="/contact_us" class="hover:underline">Contact Us</a>
                                </li>
                                <li>
                ...
                <div class="sm:flex sm:items-center sm:justify-between md:ms-0 pb-4  ms-32">
                    <span class="text-sm sm:text-center text-gray-400 md:ms-0 -ms-8">© 2022 <a href="#"
                            class="hover:underline"> </a> All Rights
                        Reserved.
                    </span>
